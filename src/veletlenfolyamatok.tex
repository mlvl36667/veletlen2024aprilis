...
\[
	F(\mu_1,\ldots,\mu_n) - \sum^{n}_{j=1} F(\mu_1,\ldots,\mu_{j-1},\lambda_j,\mu_{j+1},\ldots,\mu_{n})+\sum^{n}_{\substack{j,k=1 \\ j < k}} F(\mu_1,\ldots,\mu_{j-1},\lambda_j,\mu_{j+1},\ldots,\mu_{k-1},\lambda_k,\mu_{k+1},\ldots,\mu_{n})-\ldots+(-1)^{n} \cdots F(\lambda_1,\ldots,\lambda_n) \geq 0.
\]
